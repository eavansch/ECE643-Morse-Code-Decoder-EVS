...
/*
 * Macros for device 'letter_decoded_pio', class 'altera_avalon_pio'
 * The macros are prefixed with 'LETTER_DECODED_PIO_'.
 * The prefix is the slave descriptor.
 */
#define LETTER_DECODED_PIO_COMPONENT_TYPE altera_avalon_pio
#define LETTER_DECODED_PIO_COMPONENT_NAME letter_decoded_pio
#define LETTER_DECODED_PIO_BASE 0x30
#define LETTER_DECODED_PIO_SPAN 16
#define LETTER_DECODED_PIO_END 0x3f
#define LETTER_DECODED_PIO_BIT_CLEARING_EDGE_REGISTER 0
#define LETTER_DECODED_PIO_BIT_MODIFYING_OUTPUT_REGISTER 0
#define LETTER_DECODED_PIO_CAPTURE 0
#define LETTER_DECODED_PIO_DATA_WIDTH 32
#define LETTER_DECODED_PIO_DO_TEST_BENCH_WIRING 0
#define LETTER_DECODED_PIO_DRIVEN_SIM_VALUE 0
#define LETTER_DECODED_PIO_EDGE_TYPE NONE
#define LETTER_DECODED_PIO_FREQ 100000000
#define LETTER_DECODED_PIO_HAS_IN 1
#define LETTER_DECODED_PIO_HAS_OUT 0
#define LETTER_DECODED_PIO_HAS_TRI 0
#define LETTER_DECODED_PIO_IRQ_TYPE NONE
#define LETTER_DECODED_PIO_RESET_VALUE 0
...
/*
 * Macros for device 'space_interrupt_pio', class 'altera_avalon_pio'
 * The macros are prefixed with 'SPACE_INTERRUPT_PIO_'.
 * The prefix is the slave descriptor.
 */
#define SPACE_INTERRUPT_PIO_COMPONENT_TYPE altera_avalon_pio
#define SPACE_INTERRUPT_PIO_COMPONENT_NAME space_interrupt_pio
#define SPACE_INTERRUPT_PIO_BASE 0x60
#define SPACE_INTERRUPT_PIO_SPAN 16
#define SPACE_INTERRUPT_PIO_END 0x6f
#define SPACE_INTERRUPT_PIO_BIT_CLEARING_EDGE_REGISTER 0
#define SPACE_INTERRUPT_PIO_BIT_MODIFYING_OUTPUT_REGISTER 0
#define SPACE_INTERRUPT_PIO_CAPTURE 0
#define SPACE_INTERRUPT_PIO_DATA_WIDTH 1
#define SPACE_INTERRUPT_PIO_DO_TEST_BENCH_WIRING 0
#define SPACE_INTERRUPT_PIO_DRIVEN_SIM_VALUE 0
#define SPACE_INTERRUPT_PIO_EDGE_TYPE NONE
#define SPACE_INTERRUPT_PIO_FREQ 100000000
#define SPACE_INTERRUPT_PIO_HAS_IN 1
#define SPACE_INTERRUPT_PIO_HAS_OUT 0
#define SPACE_INTERRUPT_PIO_HAS_TRI 0
#define SPACE_INTERRUPT_PIO_IRQ_TYPE NONE
#define SPACE_INTERRUPT_PIO_RESET_VALUE 0
...
#define SYSID_ID 0
#define SYSID_TIMESTAMP 1701897820
...
#define AUDIO_CTRL_BASE 0x3040
#define AUDIO_CTRL_SPAN 16
#define AUDIO_CTRL_END 0x304f
#define AUDIO_CTRL_BIT_CLEARING_EDGE_REGISTER 0
#define AUDIO_CTRL_BIT_MODIFYING_OUTPUT_REGISTER 0
#define AUDIO_CTRL_CAPTURE 0
#define AUDIO_CTRL_DATA_WIDTH 8
#define AUDIO_CTRL_DO_TEST_BENCH_WIRING 0
#define AUDIO_CTRL_DRIVEN_SIM_VALUE 0
#define AUDIO_CTRL_EDGE_TYPE NONE
#define AUDIO_CTRL_FREQ 100000000
#define AUDIO_CTRL_HAS_IN 0
#define AUDIO_CTRL_HAS_OUT 1
#define AUDIO_CTRL_HAS_TRI 0
#define AUDIO_CTRL_IRQ_TYPE NONE
#define AUDIO_CTRL_RESET_VALUE 0

/*
 * Macros for device 'Audio_space', class 'altera_avalon_pio'
 * The macros are prefixed with 'AUDIO_SPACE_'.
 * The prefix is the slave descriptor.
 */
#define AUDIO_SPACE_COMPONENT_TYPE altera_avalon_pio
#define AUDIO_SPACE_COMPONENT_NAME Audio_space
#define AUDIO_SPACE_BASE 0x3050
#define AUDIO_SPACE_SPAN 16
#define AUDIO_SPACE_END 0x305f
#define AUDIO_SPACE_BIT_CLEARING_EDGE_REGISTER 0
#define AUDIO_SPACE_BIT_MODIFYING_OUTPUT_REGISTER 0
#define AUDIO_SPACE_CAPTURE 0
#define AUDIO_SPACE_DATA_WIDTH 16
#define AUDIO_SPACE_DO_TEST_BENCH_WIRING 0
#define AUDIO_SPACE_DRIVEN_SIM_VALUE 0
#define AUDIO_SPACE_EDGE_TYPE NONE
#define AUDIO_SPACE_FREQ 100000000
#define AUDIO_SPACE_HAS_IN 1
#define AUDIO_SPACE_HAS_OUT 0
#define AUDIO_SPACE_HAS_TRI 0
#define AUDIO_SPACE_IRQ_TYPE NONE
#define AUDIO_SPACE_RESET_VALUE 0

/*
 * Macros for device 'Audio_DACL_Dat', class 'altera_avalon_pio'
 * The macros are prefixed with 'AUDIO_DACL_DAT_'.
 * The prefix is the slave descriptor.
 */
#define AUDIO_DACL_DAT_COMPONENT_TYPE altera_avalon_pio
#define AUDIO_DACL_DAT_COMPONENT_NAME Audio_DACL_Dat
#define AUDIO_DACL_DAT_BASE 0x3060
#define AUDIO_DACL_DAT_SPAN 16
#define AUDIO_DACL_DAT_END 0x306f
#define AUDIO_DACL_DAT_BIT_CLEARING_EDGE_REGISTER 0
#define AUDIO_DACL_DAT_BIT_MODIFYING_OUTPUT_REGISTER 0
#define AUDIO_DACL_DAT_CAPTURE 0
#define AUDIO_DACL_DAT_DATA_WIDTH 32
#define AUDIO_DACL_DAT_DO_TEST_BENCH_WIRING 0
#define AUDIO_DACL_DAT_DRIVEN_SIM_VALUE 0
#define AUDIO_DACL_DAT_EDGE_TYPE NONE
#define AUDIO_DACL_DAT_FREQ 100000000
#define AUDIO_DACL_DAT_HAS_IN 0
#define AUDIO_DACL_DAT_HAS_OUT 1
#define AUDIO_DACL_DAT_HAS_TRI 0
#define AUDIO_DACL_DAT_IRQ_TYPE NONE
#define AUDIO_DACL_DAT_RESET_VALUE 0

/*
 * Macros for device 'Audio_ADCL_Dat', class 'altera_avalon_pio'
 * The macros are prefixed with 'AUDIO_ADCL_DAT_'.
 * The prefix is the slave descriptor.
 */
#define AUDIO_ADCL_DAT_COMPONENT_TYPE altera_avalon_pio
#define AUDIO_ADCL_DAT_COMPONENT_NAME Audio_ADCL_Dat
#define AUDIO_ADCL_DAT_BASE 0x3070
#define AUDIO_ADCL_DAT_SPAN 16
#define AUDIO_ADCL_DAT_END 0x307f
#define AUDIO_ADCL_DAT_BIT_CLEARING_EDGE_REGISTER 0
#define AUDIO_ADCL_DAT_BIT_MODIFYING_OUTPUT_REGISTER 0
#define AUDIO_ADCL_DAT_CAPTURE 0
#define AUDIO_ADCL_DAT_DATA_WIDTH 32
#define AUDIO_ADCL_DAT_DO_TEST_BENCH_WIRING 0
#define AUDIO_ADCL_DAT_DRIVEN_SIM_VALUE 0
#define AUDIO_ADCL_DAT_EDGE_TYPE NONE
#define AUDIO_ADCL_DAT_FREQ 100000000
#define AUDIO_ADCL_DAT_HAS_IN 1
#define AUDIO_ADCL_DAT_HAS_OUT 0
#define AUDIO_ADCL_DAT_HAS_TRI 0
#define AUDIO_ADCL_DAT_IRQ_TYPE NONE
#define AUDIO_ADCL_DAT_RESET_VALUE 0
